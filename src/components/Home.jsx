    ...
    <div className='min-h-min w-full flex justify-center items-center p-10'>    
      <div className='grid grid-cols-5 grid-rows-5 gap-16'>
        ...
        <div  className= ' w-96 h-96 row-span-3 col-span-2 bg-cover bg-center flex flex-col justify-end items-center group overflow-hidden relative' style={{backgroundImage:"url(../home/gems.jpg)"}}>
          ...
          <p className='z-20 text-white text-2xl'>Gems</p>
          <p className={`z-20 text-white mt-6 text-lg ${transition} cursor-pointer`}> Shop </p>
          <span className={` z-20 w-8 h-0.5 bg-white ${transition}`}></span>  
        ...
        <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-40 transition-opacity duration-700 z-10"></div>
          <p className='z-20 text-white text-2xl'>Gold</p>
          <p className={`z-20 text-white mt-6 text-lg ${transition} cursor-pointer underline underline-offset-8`}> Shop </p>
          {/* <span className={` z-20 w-8 h-0.5 bg-white ${transition}`}></span>     */}
        </div>

        <div className=' flex justify-center items-center bg-white  text-black'> <p className='text-2xl font-extralight '>Discover <br/>categories</p></div>
        ...
        <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-40 transition-opacity duration-700 z-10"></div>
          <p className='z-20 text-white text-2xl'>Diamond</p>
          <p className={`z-20 text-white mt-6 text-lg ${transition} cursor-pointer`}> Shop </p>
          <span className={` z-20 w-8 h-0.5 bg-white ${transition}`}></span>   
        </div>
        ...
        <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-40 transition-opacity duration-700 z-10"></div>
          <p className='z-20 text-white text-2xl'>Silver</p>
          <p className={`z-20 text-white mt-6 text-lg ${transition} cursor-pointer`}> Shop </p>
          <span className={` z-20 w-8 h-0.5 bg-white ${transition}`}></span>   
        </div>
    </div>
    ...
    <div className='flex justify-center items-center m-12'>
      <div className='grid grid-cols-2'>
            ...
            <div className='flex flex-col justify-center items-center p-10'>
              <p className='text-left text-thin'>Explore our curated collection of men’s jewelry, crafted to reflect strength <br/> and sophistication. From sleek bracelets to timeless rings,<br/> each piece is designed to elevate your style with premium materials<br/> and bold designs for the modern man.</p>
              <button className='w-20 h-10 bg-white border-2 transition-all duration-500 border-black mt-10 hover:bg-black hover:text-white'>Men</button>
              </div>
      </div>
    </div>
    <div className='flex justify-center items-center m-12'>
      <div className='grid grid-cols-2'>
            ...
            <div className='flex flex-col justify-center items-center p-10'>
              <p className='text-right'>Explore our curated collection of men’s jewelry, crafted to reflect strength <br/> and sophistication. From sleek bracelets to timeless rings,<br/> each piece is designed to elevate your style with premium materials<br/> and bold designs for the modern man.</p>
              <button className='w-20 h-10 bg-white border-2 transition-all duration-500 border-black mt-10 hover:bg-black hover:text-white'>Women</button>
            </div>
